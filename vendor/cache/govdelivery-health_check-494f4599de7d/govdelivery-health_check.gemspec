# -*- encoding: utf-8 -*-
# stub: govdelivery-health_check 0.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", ".gitlab-ci.yml", "CODE_OF_CONDUCT.md", "Gemfile", "README.md", "Rakefile", "bin/console", "bin/setup", "govdelivery-health_check.gemspec", "lib/govdelivery/health_check.rb", "lib/govdelivery/health_check/action.rb", "lib/govdelivery/health_check/checks/base.rb", "lib/govdelivery/health_check/checks/oracle.rb", "lib/govdelivery/health_check/checks/rails_cache.rb", "lib/govdelivery/health_check/checks/sidekiq.rb", "lib/govdelivery/health_check/router.rb", "lib/govdelivery/health_check/version.rb", "lib/govdelivery/health_check/web.rb"]
