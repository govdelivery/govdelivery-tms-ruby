...
describe TwilioRequestsController do
  ...
  let(:account) {create(:account, sms_vendor: vendor, name: 'aname', dcm_account_codes: %w(ACME VANDELAY))}
  ...
  describe '#create with "STOP"' do
    ...
    it 'executes a command' do
      account.create_command!('stop', params: CommandParameters.new(dcm_account_codes: %w(ACME VANDELAY)),
