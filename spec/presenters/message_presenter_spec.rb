...
describe MessagePresenter do
  ...
  context 'sms' do
    it "should link to self" do
      ...
      pres._links[:failed_recipients].should eql(failed_sms_recipients_path(@message))
      pres._links[:sent_recipients].should   eql(sent_sms_recipients_path(@message))
  ...
  context 'email' do
    it "should link to self" do
      ...
      pres._links[:failed_recipients].should eql(failed_email_recipients_path(@message))
      pres._links[:sent_recipients].should   eql(sent_email_recipients_path(@message))
  ...
  context 'voice' do
    it "should link to self" do
      ...
      pres._links[:failed_recipients].should eql(failed_voice_recipients_path(@message))
      pres._links[:sent_recipients].should   eql(sent_voice_recipients_path(@message))
      pres._links[:clicked].should           be_nil
      pres._links[:opened].should            be_nil
    end
  end
