class ChangeVendorHelpText < ActiveRecord::Migration
  def change
    ...
    SmsVendor.where(help_text: 'Go to http://bit.ly/govdhelp for help').update_all(help_text: 'This service is provided by GovDelivery. If you are a customer in need of assistance, please contact customer support.')
  end
end
