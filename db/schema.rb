...
ActiveRecord::Schema.define(version: 20_150_325_163_856) do
  ...
  add_index 'email_messages', %w(user_id created_at status subject id), name: 'em_idx4', tablespace: 'tsms_indx01'
  ...
  add_index 'email_recipient_clicks', %w(email_message_id email_recipient_id id clicked_at), name: 'erc_idx1', tablespace: 'tsms_indx01'
  add_index 'email_recipient_clicks', %w(email_message_id email_recipient_id), name: 'i922bea928d6001e8d90c6daf89654', tablespace: 'tsms_indx01'
  ...
  add_index 'email_recipient_opens', %w(email_message_id email_recipient_id id opened_at), name: 'ero_idx1', tablespace: 'tsms_indx01'
  add_index 'email_recipient_opens', %w(email_message_id email_recipient_id), name: 'i46e4b3758023b96cabd6e28d7f0bc', tablespace: 'tsms_indx01'
  ...
  add_index 'email_recipients', %w(message_id id), name: 'i_ema_rec_mes_id_id', tablespace: 'tsms_indx01'
  ...
  add_index 'sms_recipients', %w(message_id id), name: 'i_sms_recipients_message_id_id', tablespace: 'tsms_indx01'
  ...
  add_index 'stop_requests', %w(vendor_id account_id phone), name: 'i_sto_req_ven_id_acc_id_pho', unique: true, tablespace: 'tsms_indx01'
  ...
  add_index 'voice_recipients', %w(message_id id), name: 'i_voi_rec_mes_id_id', tablespace: 'tsms_indx01'
